...
// Rust type: RustOpaqueNom<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<NativeData>>
abstract class NativeData implements RustOpaqueInterface {
...
class RustyChaCha20Poly1305 {
  ...
  /// The first NONCE_LEN bytes of the `ciphertext` must contain the nonce.
  Future<NativeData> decryptFromFileToNativeData(
          {required String filePath, Uint8List? aad, BigInt? offset}) =>
      RustLib.instance.api
          .crateApiRustyChaCha20Poly1305DecryptFromFileToNativeData(
              that: this, filePath: filePath, aad: aad, offset: offset);
...
class RustyXChaCha20Poly1305 {
  ...
  Future<NativeData> decryptFromFileToNativeData(
          {required String filePath, Uint8List? aad, BigInt? offset}) =>
      RustLib.instance.api
          .crateApiRustyXChaCha20Poly1305DecryptFromFileToNativeData(
              that: this, filePath: filePath, aad: aad, offset: offset);
