...
abstract class RustLibApi extends BaseApi {
  ...
  Future<Uint8List> crateApiDecompress({required List<int> data, dynamic hint});
  ...
  Future<Uint8List> crateApiRustyChaCha20Poly1305GenerateKey({dynamic hint});

  Future<Uint8List> crateApiRustyChaCha20Poly1305GenerateNonce({dynamic hint});
  ...
  Future<Uint8List> crateApiRustyXChaCha20Poly1305GenerateKey({dynamic hint});

  Future<Uint8List> crateApiRustyXChaCha20Poly1305GenerateNonce({dynamic hint});
}
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  @override
  Future<Uint8List> crateApiDecompress(
      {required List<int> data, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        var arg0 = cst_encode_list_prim_u_8_loose(data);
