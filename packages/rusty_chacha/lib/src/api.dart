...
Future<Uint8List> decompress({required List<int> data, dynamic hint}) =>
    RustLib.instance.api.crateApiDecompress(data: data, hint: hint);
...
class RustyChaCha20Poly1305 {
  ...
  static Future<Uint8List> generateKey({dynamic hint}) =>
      RustLib.instance.api.crateApiRustyChaCha20Poly1305GenerateKey(hint: hint);
  ...
  static Future<Uint8List> generateNonce({dynamic hint}) => RustLib.instance.api
      .crateApiRustyChaCha20Poly1305GenerateNonce(hint: hint);
...
class RustyXChaCha20Poly1305 {
  ...
  static Future<Uint8List> generateKey({dynamic hint}) => RustLib.instance.api
      .crateApiRustyXChaCha20Poly1305GenerateKey(hint: hint);

  /// Important: A nonce must only be used once.
  /// Do not encrypt multiple pieces of data with the same nonce.
  static Future<Uint8List> generateNonce({dynamic hint}) => RustLib.instance.api
      .crateApiRustyXChaCha20Poly1305GenerateNonce(hint: hint);
